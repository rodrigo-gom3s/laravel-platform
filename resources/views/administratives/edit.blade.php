        ...
        <div class="max-full">
            <section>
                <div class="flex flex-wrap justify-end items-center gap-4 mb-4">
                    <x-button href="{{ route('administratives.create', ['administrative' => $administrative]) }}" text="New" type="success" />
                    <x-button href="{{ route('administratives.show', ['administrative' => $administrative]) }}" text="View" type="info" />
                ...
                <header>
                    <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">
                        Edit associated "{{ $administrative->name }}"
                    </h2>
...
<form class="hidden" id="form_to_delete_photo" method="POST" action="{{ route('administratives.photo.destroy', ['administrative' => $administrative]) }}">
    @csrf
    @method('DELETE')
</form>
@endsection